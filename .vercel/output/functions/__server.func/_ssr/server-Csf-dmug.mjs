...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CvAc8Zvd.mjs");
...
const manifest = {
  "511e27ecc29a96601c39bb2f1ff49c51ce0b33adf7e9b4f146058551e024caa4": {
    functionName: "getReleasedFileUrl_createServerFn_handler",
    importer: () => import("./admin.functions-D8LEXiwP.mjs")
  },
  "89f029f4fc21ed092423cd54f44fb61078423691288a3a89663a6e0973cd86ea": {
    functionName: "adminLogin_createServerFn_handler",
    importer: () => import("./admin.functions-D8LEXiwP.mjs")
  },
  "b7e94af2f4382ab807fb804946f8df2799372e5e1773ef6da2fb37e8ea5fa6d1": {
    functionName: "getPanaderiasPage_createServerFn_handler",
    importer: () => import("./admin.functions-D8LEXiwP.mjs")
  },
  "c992795288aaa10f3709a622afc2f258eb87ee7f2d84edd6d22f6900f253db58": {
    functionName: "uploadPanaderias_createServerFn_handler",
    importer: () => import("./admin.functions-D8LEXiwP.mjs")
  },
  "cc0d14e99a540c75843bbb8f2f0698728a16a9b2d523da5330fd858bd7ab2a73": {
    functionName: "getPanaderiasCiudades_createServerFn_handler",
    importer: () => import("./admin.functions-D8LEXiwP.mjs")
  },
  "ea473cd86d31ba70cbf229d2dc5fe0fc55abb5438b4ebec30465a40cbae1a1ad": {
    functionName: "uploadReleasedFile_createServerFn_handler",
    importer: () => import("./admin.functions-D8LEXiwP.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CiIlO4Cp.mjs"),
    import("./start-Dudbq2O0.mjs"),
